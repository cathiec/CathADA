                                ...
                                (i == 0 && !is_sat(CURRENT)))
                        {
                            ...
                            for(int j = 0; j < state_set.size(); j++)
                            {
                                ...
                                if(_F_index.find(xxx)->second == 1)
                                    final_one = final_one && z3::implies(parse("true"), state_set[j]);
                                else
                                    final_one = final_one && z3::implies(state_set[j], parse("false"));
                            }
